...
class DigilanTokenUser
{
    ...
    public static function create_ap_user($mac, $social_id, $customized_user_info = array())
    {
        ...
        $decoded_customized_user_info = json_decode($json_customized_user_info);
        $insert_data = $wpdb->insert("{$wpdb->prefix}digilan_token_meta_users_$installed_version", array(
            "user_id" => $last_id,
            "gender" => $decoded_customized_user_info->gender,
            "age" => $decoded_customized_user_info->age,
            "nationality" => $decoded_customized_user_info->nationality,
            "stay_length" => $decoded_customized_user_info->stay_length,
