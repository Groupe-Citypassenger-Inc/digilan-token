...
?>
    <?php if ($state == 'not-tested') : ?>
      <div class="dlt-box dlt-box-blue">
        ...
        <p>
          <?php _e('Before you can start letting your users register with your app it needs to be tested. This test makes sure that no users will have troubles with the login and registration process. <br> If you see error message in the popup check the copied ID and secret or the app itself. Otherwise your settings are fine.', 'digilan-token'); ?>
        </p>
        ...
        <p id="dlt-test-configuration">
          ...
          <span id="dlt-test-please-save">
            <?php _e('Please save your changes to verify settings.', 'digilan-token'); ?>
          </span>
        </p>
      </div>
    <?php endif; ?>
    ...
    <?php if ($provider->settings->get('tested') == '1') : ?>
      <div
        class="dlt-box <?php if ($state == 'configured') : ?>dlt-box-green<?php else : ?> dlt-box-yellow dlt-box-exclamation-mark<?php endif; ?>"
      >
        ...
        <p id="dlt-test-configuration">
          ...
          <span id="dlt-test-please-save">
            <?php _e('Please save your changes before verifying settings.', 'digilan-token'); ?>
          </span>
        </p>
      </div>
<?php endif;
