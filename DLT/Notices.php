...
class Notices
{
    ...
    private function __construct()
    {
        ...
        if (basename($_SERVER['PHP_SELF']) !== 'admin.php' || $page !== 'digilan-token-plugin') {
    ...
    public static function displayNotices()
    {
        ...
        if (!empty($html)) {
            echo '<div class="dlt-admin-notices">' . $html . '</div>';
        }
    }
...
?>
            <div id="dlt-notices-fallback" onclick="this.parentNode.removeChild(this);">
                ...
                <style>
                    ...
                    .admin-bar #dlt-notices-fallback {
                        top: 42px;
                    }

                    #dlt-notices-fallback>div {
                        position: relative;
                        background: #fff;
                    ...
                    #dlt-notices-fallback>div.error {
                        display: block;
                        border-left-color: #dc3232;
                    }

                    #dlt-notices-fallback>div.updated {
                        display: block;
                        border-left-color: #46b450;
                    }

                    #dlt-notices-fallback p {
                        margin: .5em 0;
                        padding: 2px;
                    }

                    #dlt-notices-fallback>div:after {
                        position: absolute;
                        right: 5px;
                        top: 5px;
                        content: '\00d7';
