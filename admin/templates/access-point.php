            ...
            <td>
              <fieldset>
                <label for="landing-page"> 
                  <input type="url" placeholder="<?php _e("Valid URL adress"); ?>" id="digilan-token-lpage-input" pattern="^http(s)?:\/\/[\w\-]+(\.[\w\-]+)+(:\d+)?[\/\w\-]+$" name="digilan-token-lpage" class="regular-text" value="<?php htmlspecialchars($settings->get('landing-page'), ENT_QUOTES, 'UTF-8'); ?>" />
                </label>
              </fieldset>
            </td>
          </tr>
