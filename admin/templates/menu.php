...
<div class="dlt-admin-nav-bar">
    <?php if (DigilanToken::isFromCitybox()) : ?>
        ...
        <a href="<?php echo DigilanTokenAdmin::getAdminUrl('form'); ?>" class="dlt-admin-nav-tab<?php if ($view === 'form') : ?> dlt-admin-nav-tab-active<?php endif; ?>"><?php _e('Form', 'digilan-token'); ?></a>
