...
<div class="dlt-admin-content">
    ...
    ?>
        <p><?php printf(__('%s detected that your login url changed. You must update the Oauth redirect URIs in the related social applications.', 'digilan-token'), '<b>Digilan Token</b>'); ?></p>
        ...
        <a href="<?php echo wp_nonce_url(DigilanTokenAdmin::getAdminUrl('update_oauth_redirect_url'), 'digilan-token-plugin_update_oauth_redirect_url'); ?>" class="button button-primary">
