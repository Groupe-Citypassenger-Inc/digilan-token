    ...
    <table class="form-table">
      <tbody>
        <tr>
          <th scope="row">
            <label for="client_id">
              <?php _e('Client ID', 'digilan-token'); ?>
          ...
          <td>
            <input
              ...
              type="text"
              id="client_id"
              value="<?php echo esc_attr($settings->get('client_id')); ?>"
              class="regular-text"
              style="width:40em;"
            />
            <p class="description" id="tagline-client_id">
              <?php
              printf(
        ...
        <tr>
            <th scope="row">
              <label for="client_secret"><?php _e('Client Secret', 'digilan-token'); ?>
                - <em>(<?php _e('Required', 'digilan-token'); ?>)</em>
              </label>
            </th>
            <td>
              <input
                ...
                type="text"
                id="client_secret"
                value="<?php echo esc_attr($settings->get('client_secret')); ?>"
                class="regular-text"
              />
            </td>
        </tr>
