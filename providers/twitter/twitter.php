...
*/
class DigilanTokenSocialProviderTwitter extends DigilanTokenSocialProvider
{

  /** @var DigilanTokenSocialProviderTwitterClient */
  protected $client;
  ...
  {
    __('Continue with <b>Twitter</b>', 'digilan-token');
    __('Link account with <b>Twitter</b>', 'digilan-token');
    __('Unlink account from <b>Twitter</b>', 'digilan-token');
  }
  ...
  /**
   *
   * @return DigilanTokenSocialProviderTwitterClient
   */
  public function getClient()
  {
    if ($this->client === null) {
      ...
      $this->client = new DigilanTokenSocialProviderTwitterClient(
        $this->id,
        $this->settings->get('consumer_key'),
        $this->settings->get('consumer_secret')
      );
  ...
  {
    $response = $this->getClient()->get('account/verify_credentials', array(
      'include_email' => 'true',
...
DigilanToken::addProvider(new DigilanTokenSocialProviderTwitter());
